 ...
 * @author Sharayu
 */
@WebServlet(name = "pmlogin", urlPatterns = {"/pmlogin"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
          ...
          /*JSP*/
           ...
           rs=st.executeQuery("select * from pmlogin where username='"+uname+"'");
           while(rs.next())
           {
           ...
           {
                        RequestDispatcher rd=request.getRequestDispatcher("pmdash.jsp");
