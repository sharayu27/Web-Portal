 ...
 * @author Sharayu
 */
@WebServlet(name = "ent_code", urlPatterns = {"/ent_code"})
public class ent_code extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            String check_em=request.getParameter("email");//j
            ...
            while(rs.next())
           {
              ...
              {
                    RequestDispatcher rd=request.getRequestDispatcher("emailcode.jsp");
